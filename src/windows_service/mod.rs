...
#[cfg(target_os = "windows")]
async fn run_service_tasks(power_resume_rx: Option<mpsc::UnboundedReceiver<()>>, safe_mode: bool) {
    ...
    guardian_agent::run_reconnect_loop(
        crate::runtime::WindowsAgent::new(!safe_mode),
        active_client_tx,
    )
    .await;
}
