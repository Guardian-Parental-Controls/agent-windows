...
use windows_sys::Win32::System::Registry::{
    HKEY_LOCAL_MACHINE, KEY_READ, KEY_SET_VALUE, KEY_WOW64_64KEY, REG_OPTION_NON_VOLATILE, REG_SZ,
    RegCloseKey, RegCreateKeyExW, RegOpenKeyExW, RegQueryValueExW, RegSetValueExW,
};

#[cfg(target_os = "windows")]
const SAFE_BOOT_MINIMAL: &str = r"SYSTEM\CurrentControlSet\Control\SafeBoot\Minimal\GuardianAgent";
#[cfg(target_os = "windows")]
const SAFE_BOOT_NETWORK: &str = r"SYSTEM\CurrentControlSet\Control\SafeBoot\Network\GuardianAgent";
#[cfg(target_os = "windows")]
